...
from utils.data_client import get_waveforms as _get_waveforms, SOURCES
...
def main(argv=None):
    ...
    parser.add_argument("--source", choices=SOURCES, default="fdsn",
                        help="Waveform backend: 'fdsn' (EarthScope, public) or "
                             "'pnwstore' (UW internal archive). Default: fdsn")
    ...
    client = Client(args.fdsn)  # kept for backward compat; routing via data_client
