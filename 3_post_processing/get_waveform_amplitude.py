...
Usage:
    python get_waveform_amplitude.py --events ../data/Cascadia_relocated_catalog_ver_3.csv \
...
This script:
 ...
 - downloads waveforms from PNWSTORE or IRIS/EARThSCOPE for each pick's station
