...
# Parameters
year1 = 2015
filepath = f"/home/hbito/cascadia_obs_ensemble_backup/data/picks_{year1}_127_129/"
...
inventory = client_inventory.get_stations(network="C8,7D,7A,CN,NV,UW,UO,NC,BK,TA,OO,PB,X6,Z5,X9", station="*", minlatitude=40,minlongitude=-129,maxlatitude=50,maxlongitude=-127, starttime=time1.strftime('%Y%m%d'),endtime=time2.strftime('%Y%m%d'))
