...
SCRIPT_FIGURES = [
    ...
    ("fig_regions/mendocino.png", _PHASE5, ["--region", "mendocino", "--gmrt", "med"],
     "cascadia_ML_map_mendocino.png", _MAG),
    ("fig_regions/endeavour.png", _PHASE5, ["--region", "endeavour", "--gmrt", "med"],
     "cascadia_ML_map_endeavour.png", _MAG),
    ("fig_regions/gorda.png", _PHASE5, ["--region", "gorda", "--gmrt", "med"],
     "cascadia_ML_map_gorda.png", _MAG),
    ("fig_regions/wa_margin.png", _PHASE5, ["--region", "wa_margin", "--gmrt", "med"],
     "cascadia_ML_map_wa_margin.png", _MAG),
    ("fig_regions/or_margin.png", _PHASE5, ["--region", "or_margin", "--gmrt", "med"],
