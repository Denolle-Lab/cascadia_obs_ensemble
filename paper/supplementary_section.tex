...
network lowers the magnitude of completeness by roughly one to three units relative to
the land-based ANSS: $M_c\approx1.6$--$1.7$ vs $2.1$ at the Mendocino and Gorda
segments, $2.3$ vs $4.2$ at the Blanco transform, and $2.2$ vs $5.0$ at the Endeavour
segment, with Gutenberg--Richter $b\sim1.0$--$1.6$ (max-curvature $M_c$, Aki--Utsu $b$).
