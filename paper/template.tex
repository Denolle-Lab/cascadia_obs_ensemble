...
%% anonymous: produces an anonymous PDF for double-blind review. Will NOT print authors information and acknowledgements, but WILL PRINT data availability section, so be careful!
...
\begin{document}
	...
	\makeseistitle{
		\begin{summary}{Abstract}
			We use a novel ML pipeline to discover new earthquakes in cascadia
		\end{summary}
		%	 \begin{thai}
