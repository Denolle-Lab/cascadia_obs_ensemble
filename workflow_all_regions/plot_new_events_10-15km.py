...
new_events = new_events.loc[(new_events['depth'] >= 10)&(new_events['depth'] < 15)]
...
fig_title = 'New Event (10-15 km deep) from any region'

path = f'/home/hbito/cascadia_obs_ensemble/data/datasets_{year}/plots_new_events_10-15km/'
